...
public:
    DecisionTreeRegression(int min_samples_split = 5, int max_depth = 100, int n_feats = 0);
    ~DecisionTreeRegression();
    DecisionTreeRegression(const DecisionTreeRegression&) = delete;
    DecisionTreeRegression& operator=(const DecisionTreeRegression&) = delete;
